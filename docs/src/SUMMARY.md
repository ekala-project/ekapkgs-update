...
- [Command-Line Interface](./cli/README.md)
  ...
  - [worktrees - Manage Artifacts](./cli/worktrees.md)
  - [export/apply - LLM Integration](./cli/export-apply.md)
  - [migrate - Package Migration](./cli/migrate.md)
...
- [Updating Single Packages](./use-cases/single-package.md)
- [Batch Updates](./use-cases/batch-updates.md)
- [CI/CD Integration](./use-cases/ci-cd.md)
- [Testing Updates](./use-cases/testing.md)
- [Debugging Failures](./use-cases/debugging.md)
...
- [PR Enhancements](./advanced/pr-enhancements.md)
- [Backoff Strategy](./advanced/backoff.md)
- [Security Considerations](./advanced/security.md)

# Reference

- [Environment Variables](./reference/environment.md)
- [Package Schema](./reference/package-schema.md)
